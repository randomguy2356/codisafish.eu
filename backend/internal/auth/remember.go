...
//			}
//
//			insert := "INSERT INTO remember_me (user_id, token_hash, expires_at) VALUES (?, ?, ?)"
//
//			var token string
//
//			for {
...
//
//				_, err = db.ExecContext(context, insert, user_id, token_hash, time.Now().Add(30*24*time.Hour))
//				if err != nil {
